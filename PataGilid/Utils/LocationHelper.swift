...
class LocationHelper {
    ...
    static func mapToInternalRegion(adminArea: String, subAdminArea: String, locality: String) -> (String?, IslandGroup?) {
        let searchString = "\(adminArea) \(subAdminArea) \(locality)".lowercased()
        ...
        if searchString.contains("ilocos") || searchString.contains("pangasinan") || searchString.contains("la union") {
            ...
            return ("Region 4A (CALABARZON)", .luzon)
            ...
            return ("Region 4B (MIMAROPA)", .luzon)
            ...
            return ("NCR (National Capital Region)", .luzon)
        }
        ...
        // MINDANAO
            ...
            return ("BARMM (Bangsamoro)", .mindanao)
        }
